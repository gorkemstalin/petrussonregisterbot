////////////////////////////////////////////
let rolid = "759291083598987275"; // BURAYA KULLANICININ TÜM ROLLERİ ALINDIKTAN SONRA VERİLECEK ROLÜN İDSİNİ YAZIN , YAZMAZSANIZ TÜM ROLLERİ ALIR SADECE. 
///////////////////////////////////////////
exports.run = async (client, message, args) => {
  if (!message.member.roles.has("760139907770482719"))//Bu komutu kullanıcak kişinin ıdsini yazın.
